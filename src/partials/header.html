<nav class="navbar navbar-expand-lg navbar-light bg-white shadow">
  <div class="container">
    <a class="d-flex align-items-center gap-2 order-lg-1" href="@@webRoot/index.html">
    ...
    <div class="collapse navbar-collapse order-lg-2" id="navbarSupportedContent">
      <ul class="navbar-nav mx-auto mb-2 mb-lg-0">
        <li class="nav-item">
          <a class="nav-link active" aria-current="page" href="@@webRoot/index.html">Dashboard</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="@@webRoot/components/accordions.html">Components</a>
        </li>

        <li class="nav-item">
          <a href="@@webRoot/docs/index.html" class="nav-link">Docs</a>
        </li>
      </ul>
    </div>
  </div>
